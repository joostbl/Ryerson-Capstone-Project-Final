...
```{r}
#Matthews_MCC_RF = mcc_vec(pred_lda$predicted, pred_lda$actual)
...
```{r}
#Brier_score_RF = BrierScore(glm(pred_lda$predicted ~ ., data= pred_lda, 
              #                  family = binomial))
#Brier_score_RF
```
...
```{r}
#Matthews_MCC_Tree = mcc_vec(pred_lda_Tree$predicted, pred_lda_Tree$actual)
...
```{r}
#Brier_score_Tree = BrierScore(glm(pred_lda_Tree$predicted ~ ., data= pred_lda_Tree, 
           #                     family = binomial))
